...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between pb-20 sm:pb-0">
      ...
      {/* Sticky Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 border-t-0 border-x-0 border-slate-700 px-6 py-4 flex justify-between items-center transition-all duration-300 bg-background/80">
        ...
        <div className="md:hidden glass p-2 rounded-lg cursor-pointer">
          {/* Menu icon SVG */}
      ...
      <footer className="w-full text-center py-12 border-t border-slate-700 mt-20 relative z-10">
         <div className="container mx-auto px-6">
            <h2 className="text-2xl font-bold mb-4 tracking-tighter">ARUN <span className="text-brand-accent">SUDHAVENI</span></h2>
